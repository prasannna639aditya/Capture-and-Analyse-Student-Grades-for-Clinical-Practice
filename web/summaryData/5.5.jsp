<%-- 
    Document   : 5.5
    Created on : 06-Mar-2016, 20:50:58
    Author     : Delaney
--%>
...
<html>
    <head>
        ...
        <title>Group 5.5 Summary Data</title>
    </head>
    <body>
        ...
        %>
                    <p id="top">
        <%
             out.println("See the summary data for group 5.5");
        %>
                    </p>
                    <p>
        <%
             out.print(group.studentData("5.5"));
        %>
                    </p>
                    </div>
                    ...
                    <p id="top">
            <%
             out.println("See the treatment summary data for group 5.5");
        %>
                    </p>
                    <p>
        <%
             out.print(data.studentData("5.5"));
