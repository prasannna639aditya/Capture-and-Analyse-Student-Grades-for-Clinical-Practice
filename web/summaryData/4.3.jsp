...
<html>
    <head>
        ...
        <title>Group 4.3 Summary Data</title>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="A">
                    ...
                    <p id="top">
                        <%
                             out.println("See the summary data for group 4.3");
                        %>
                    </p>
                    <p>
                        <%
                ...
                <div class="tab-pane fade" id="B">
                    <p id="top">
                        <%
                         out.println("See the treatment summary data for group 4.3");
                        %>
                    </p>
                    <p>
                        <%
                             out.print(data.studentData("4.3"));
