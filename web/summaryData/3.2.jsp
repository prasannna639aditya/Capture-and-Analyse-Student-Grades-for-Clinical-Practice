<%-- 
    Document   : 3.2
    Created on : 06-Mar-2016, 20:38:11
    Author     : Delaney
--%>
...
<html>
    <head>
        ...
        <title>Group 3.2 Summary Data</title>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="A">
                    ...
                    <p id="top">
                        <%
                             out.println("See the summary data for group 3.2");
                        %>
                    </p>
                    <p>
                        <%
                ...
                <div class="tab-pane fade" id="B">
                    <p id="top">
                        <%
                         out.println("See the treatment summary data for group 3.2");
                        %>
                    </p>
                    <p>
                        <%
                             out.print(data.studentData("3.2"));
