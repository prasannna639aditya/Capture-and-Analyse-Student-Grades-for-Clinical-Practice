<%-- 
    Document   : 4.5
    Created on : 06-Mar-2016, 20:48:25
    Author     : Delaney
--%>
...
<html>
    <head>
        ...
        <title>Group 4.5 Summary Data</title>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="A">
                    ...
                    <p id="top">
                        <%
                             out.println("See the summary data for group 4.5");
                        %>
                    </p>
                    <p>
                        <%
                             out.print(group.studentData("4.5"));
                        %>
                    </p>
                </div>
                <div class="tab-pane fade" id="B">
                    <p id="top">
                        <%
                         out.println("See the treatment summary data for group 4.5");
                        %>
                    </p>
                    <p>
                        <%
                             out.print(data.studentData("4.5"));
