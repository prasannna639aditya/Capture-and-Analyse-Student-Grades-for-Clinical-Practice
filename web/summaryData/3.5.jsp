...
<html>
    <head>
        ...
        <title>Group 3.5 Summary Data</title>
    </head>
    <body>
        ...
        %>
                    <p id="top">
        <%
             out.println("See the summary data for group 3.5");
        %>
                    </p>
                    <p>
        <%
        ...
        %>
                    ...
                    <p id="top">
            <%
             out.println("See the treatment summary data for group 3.5");
        %>
                    </p>
                    <p>
        <%
             out.print(data.studentData("3.5"));
