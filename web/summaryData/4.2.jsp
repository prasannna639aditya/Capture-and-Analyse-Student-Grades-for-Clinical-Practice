<%-- 
    Document   : 4.2
    Created on : 06-Mar-2016, 20:45:36
    Author     : Delaney
--%>
...
<html>
    <head>
        ...
        <title>Group 4.2 Summary Data</title>
    </head>
    <body>
        ...
        %>
                    <p id="top">
        <%
             out.println("See the summary data for group 4.2");
        %>
                    </p>
                    <p>
        <%
             out.print(group.studentData("4.2"));
        %>
                    </p>
                    </div>
                    ...
                    <p id="top">
            <%
             out.println("See the treatment summary data for group 4.2");
        %>
                    </p>
                    <p>
        <%
             out.print(data.studentData("4.2"));
