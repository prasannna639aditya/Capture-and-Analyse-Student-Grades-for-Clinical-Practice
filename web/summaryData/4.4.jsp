<%-- 
    Document   : 4.4
    Created on : 06-Mar-2016, 20:47:53
    Author     : Delaney
--%>
...
<html>
    <head>
        ...
        <title>Group 4.4 Summary Data</title>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="A">
                    ...
                    <p id="top">
                        <%
                             out.println("See the summary data for group 4.4");
                        %>
                    </p>
                    <p>
                        <%
                             out.print(group.studentData("4.4"));
                        %>
                    </p>
                </div>
                <div class="tab-pane fade" id="B">
                    <p id="top">
                        <%
                         out.println("See the treatment summary data for group 4.4");
                        %>
                    </p>
                    <p>
                        <%
                             out.print(data.studentData("4.4"));
