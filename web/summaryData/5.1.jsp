...
<html>
    <head>
        ...
        <title>Group 5.1 Summary Data</title>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="A">
                    ...
                    <p id="top">
                        <%
                             out.println("See the summary data for group 5.1");
                        %>
                    </p>
                    <p>
                        <%
                             out.print(group.studentData("5.1"));
                        %>
                    </p>
                </div>
                <div class="tab-pane fade" id="B">
                    <p id="top">
                        <%
                         out.println("See the treatment summary data for group 5.1");
                        %>
                    </p>
                    <p>
                        <%
                             out.print(data.studentData("5.1"));
